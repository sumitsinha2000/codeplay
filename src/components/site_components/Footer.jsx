          ...
          <ul className="list-none flex flex-row justify-between h-full gap-4">
            <li className="h-8 w-8">
              <a href={props.linkfb} target="_new">
                <FaFacebook size="1.5rem" title="facebook" color="grey" />
              </a>
            </li>
            <li className="h-8 w-8">
              <a href={props.linkInsta} target="_new">
                <FaInstagram size="1.5rem" title="instagram" color="grey" />
              </a>
            </li>
            <li className="h-8 w-8">
              <a href={props.linkIn} target="_new">
                <FaLinkedin size="1.5rem" title="linked in" color="grey" />
              </a>
            </li>
            <li className="h-8 w-8">
              <a href={props.linkGit} target="_new">
                <FaGithub size="1.5rem" title="github" color="grey" />
              </a>
            </li>
            <li className="h-8 w-8">
              <a href={props.linkYt} target="_new">
                <FaYoutube size="1.5rem" title="youtube" color="grey" />
              </a>
            </li>
          </ul>
        </div>
